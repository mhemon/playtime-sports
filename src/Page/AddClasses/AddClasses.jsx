    ...
    const onSubmit = data => {
        ...
        .then(ImgResponse => {
            if(ImgResponse.success){
                ...
                const newClass = {name, available_seats: parseInt(available_seats), email: user?.email, instructor_name: user?.displayName, image: ImgURL, price: parseFloat(price), status: "pending"}
                // console.log(newItem);
